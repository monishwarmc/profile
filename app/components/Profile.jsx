  ...
  return (
    <div className="flex flex-col items-center text-zinc-800 dark:text-slate-400" id="">
      <br/>
        ...
        className="w-44 h-56 sm:w-80 sm:h-96 mt-6 py-6 rounded-4xl animate-pulsee shade"
        />
        <h1
        ...
        >Working @ <a href="https://www.jsw.in/" target="_blank" className="sm:hover:text-6xl sm:text-5xl hover:text-3xl text-2xl hover:no-underline underline flex sm:pl-3 pl-1 animate-pulse">
            <img alt="skcet" src='./skcet.png' width={43} height={39} className="rounded-full mx-1 my-1 w-9 h-9 sm:w-11 sm:h-11"/>
            JSW steel</a></h2>
        <h3
